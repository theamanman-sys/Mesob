        ...
        <div>
          ...
          {browseTab === 'properties' ? <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <iframe src={`/api/proxy/bank?url=${encodeURIComponent('https://www.properties.et')}`} className="w-full min-h-[300px] md:min-h-[450px] lg:min-h-[600px]" title="properties.et" loading="lazy" referrerPolicy="no-referrer" />
            </div>
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <iframe src={`/api/proxy/bank?url=${encodeURIComponent('https://betoch.com')}`} className="w-full min-h-[300px] md:min-h-[450px] lg:min-h-[600px]" title="betoch.com" loading="lazy" referrerPolicy="no-referrer" />
            </div>
