        ...
        <div>
          ...
          {browseTab === 'properties' ? <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <iframe src="https://www.properties.et" className="w-full min-h-[300px] md:min-h-[450px] lg:min-h-[600px]" title="properties.et" sandbox="allow-scripts allow-same-origin allow-forms allow-popups" />
            </div>
            <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
              ...
              <iframe src="https://betoch.com" className="w-full min-h-[300px] md:min-h-[450px] lg:min-h-[600px]" title="betoch.com" sandbox="allow-scripts allow-same-origin allow-forms allow-popups" />
            </div>
