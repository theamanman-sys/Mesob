    ...
    <div>
      ...
      <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        ...
        <div className="bg-gray-50 p-2">
          <iframe src={`/api/proxy/bank?url=${encodeURIComponent('https://qetero.com')}`} title="Qetero Appointment Booking" className="w-full min-h-[300px] md:min-h-[450px] lg:min-h-[600px] rounded-xl border-0" loading="lazy" referrerPolicy="no-referrer" />
        </div>
