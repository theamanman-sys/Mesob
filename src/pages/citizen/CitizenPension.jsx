      ...
      <div className="grid md:grid-cols-2 gap-6">
        <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-200">
          ...
          <div className="space-y-4">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Current Age: <span className="font-bold text-blue-600">{age}</span></label>
              <input type="range" min="18" max="70" value={age} onChange={(e) => setAge(Number(e.target.value))} className="w-full" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Retirement Age: <span className="font-bold text-blue-600">{retirementAge}</span></label>
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Contribution Rate: <span className="font-bold text-blue-600">{contribution}%</span></label>
              <input type="range" min="1" max="20" value={contribution} onChange={(e) => setContribution(Number(e.target.value))} className="w-full" />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">Current Savings (ETB)</label>
            ...
            <div className="space-y-6">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-green-50 rounded-lg text-center">
                  <p className="text-sm text-gray-500">Monthly Payout</p>
              ...
              <div className="space-y-3 p-4 bg-gray-50 rounded-lg">
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-semibold text-gray-800">{result.years} years</span>
                </div>
                <div className="flex justify-between text-sm">
