...
function setSecurityHeaders(res) {
  ...
  res.setHeader('Content-Security-Policy', "default-src 'self'; script-src 'self' 'unsafe-eval' https://accounts.google.com https://static.cloudflareinsights.com https://www.googletagmanager.com https://cdnjs.cloudflare.com https://qetero.com https://www.ethiojobs.net https://nbe.gov.et https://www.properties.et https://betoch.com https://id.et https://justice.gov.et https://www.ecx.com.et; style-src 'self' 'unsafe-inline' https://fonts.googleapis.com https://cdnjs.cloudflare.com https://qetero.com https://www.ethiojobs.net https://nbe.gov.et https://www.properties.et https://betoch.com https://id.et https://justice.gov.et https://www.ecx.com.et; connect-src 'self' https://accounts.google.com https://www.googleapis.com https://open.er-api.com; img-src 'self' data: https://*.googleapis.com https://*.gstatic.com https://i.ytimg.com https://www.properties.et https://betoch.com https://qetero.com https://www.ethiojobs.net https://justice.gov.et https://www.ecx.com.et; frame-src 'self' https://accounts.google.com https://id.et https://justice.gov.et https://qetero.com https://www.ethiojobs.net https://www.ecx.com.et https://www.properties.et https://betoch.com https://www.youtube.com https://www.youtube-nocookie.com; font-src 'self' data: https://fonts.gstatic.com; base-uri 'self' https://qetero.com https://www.ethiojobs.net https://nbe.gov.et https://www.properties.et https://betoch.com https://id.et https://justice.gov.et https://www.ecx.com.et https://www.youtube.com; form-action 'self'; manifest-src 'self'")
}
  ...
  try {
    ...
    if (request.method === 'GET' && p === '/proxy/bank') {
      ...
      return fetchBuf(targetUrl, 5).then(({ buf, hdrs, st, finalUrl }) => {
        ...
        const proxyScript = `<script>(function(){var pu=${JSON.stringify(proxyUrl)};var a=document.createElement('a');var lo=window.location.origin;var noop=new Response('{}',{status:200,headers:{'Content-Type':'application/json'}});var pr=function(u){if(typeof u==='string'&&!u.startsWith(pu)){a.href=u;if(a.href.indexOf(lo)===0)return u;return pu+encodeURIComponent(a.href)}return u};var f=window.fetch.bind(window);window.fetch=function(u,i){if(typeof u!=='string'||u.startsWith(pu))return f(u,i);a.href=u;if(a.href.indexOf(lo)===0)return Promise.resolve(noop.clone());var ni={};if(i){for(var k in i){if(i.hasOwnProperty(k))ni[k]=i[k]}}ni.headers={};if(i&&i.headers){for(var h in i.headers){if(i.headers.hasOwnProperty(h))ni.headers[h]=i.headers[h]}}ni.headers['x-proxy-fetch']='1';return f(pu+encodeURIComponent(a.href),ni).then(function(r){if(u.indexOf('/api/')!==-1){var ct=r.headers.get('content-type')||'';if(ct.indexOf('text/html')!==-1)return noop.clone()}return r})['catch'](function(){return noop.clone()})};var ox=XMLHttpRequest.prototype.open;XMLHttpRequest.prototype.open=function(m,u){this._proxyUrl=u;if(typeof u==='string'&&!u.startsWith(pu)){a.href=u;if(a.href.indexOf(lo)===0)return ox.call(this,m,u);return ox.call(this,m,pu+encodeURIComponent(a.href))}return ox.call(this,m,u)};var sx=XMLHttpRequest.prototype.send;XMLHttpRequest.prototype.send=function(b){var x=this;var lx=x.onload;x.onload=function(e){if(x._proxyUrl&&x._proxyUrl.indexOf('/api/')!==-1){var ct=x.getResponseHeader('content-type')||'';if(ct.indexOf('text/html')!==-1){Object.defineProperty(x,'responseText',{configurable:true,get:function(){return '{}'}});Object.defineProperty(x,'response',{configurable:true,get:function(){return '{}'}})}}if(lx)return lx.call(this,e)};return sx.call(this,b)};try{var h=window.history;var rs=h.replaceState.bind(h);var ps=h.pushState.bind(h);h.replaceState=function(s,t,u){try{return rs(s,t,u)}catch(e){}};h.pushState=function(s,t,u){try{return ps(s,t,u)}catch(e){}}}catch(e){}document.addEventListener('click',function(e){var l=e.target.closest('a');if(l&&l.href&&l.href.indexOf(lo)!==0&&!l.target){e.preventDefault();window.location.href=pu+encodeURIComponent(l.href)}})})();<\/script>`
